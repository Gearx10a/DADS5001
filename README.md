...
ขณะเดียวกันปริมาณการผลิตพลังงานจาก Natural Gas ก็มีการเพิ่มขึ้นในอัตราที่ต่ำ เห็นได้จาก เส้น Natural Gas ที่ไม่ได้แกว่งตัวมาก นอกจากนี้การจะคาดการณ์ปริมาณการผลิตพลังงานจาก Renewable ทำได้ยากกว่าของ Natural Gas เนื่องจาก เส้น Renewable มีการแกว่งตัวที่สูงกว่าของเส้น Natural Gas แสดงให้เห็นว่า
...
การศึกษาความคุ้มค่าในการลงทุน Solar Rooftop ครั้งนี้ เป็นเพียงกรณีศึกษาผ่านผู้ใช้ไฟฟ้ารายหนึ่งเท่านั้น ซึ่งอาจมิได้นำไปอนุมานแทนกลุ่มประชากรผู้ใช้ไฟฟ้าได้ เป็นเพียงการอธิบายให้เห็นภาพแนวทางการคำนวญความคุ้มค่าในการลงทุนเท่านั้น
...
- NPV มีค่าเป็นบวก
- IRR มีค่ามากกว่า ต้นทุนของเงินลงทุนในโครงการ (Inflation Rate)
- Payback Period มีค่าน้อยกว่า ระยะการลงทุนของโครงการ 
