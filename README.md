...
จากกราฟของสัดส่วน CO2 ต่อ หน่วยไฟฟ้า(kwh) ในปี 1996 – 2022 พบว่า สัดส่วน CO2 ต่อ หน่วยไฟฟ้า (kwh) มีแนวโน้มที่ลดลง กล่าวได้ว่า การผลิตพลังงานไฟฟ้า 1 kwh ปล่อย CO2 ได้น้อยลง แสดงให้เห็นถึงประสิทธิภาพการผลิตพลังงานไฟฟ้าที่สูงขึ้นในด้านการลดมลพิษจาก CO2  
...
จากกราฟปริมาณการรับซื้อพลังงานสะอาดจากผู้ผลิตพลังงาน ตั้งแต่ปี 2550 ถึง 2564 เห็นได้ว่า การปริมาณการผลิตพลังงานสะอาดมีแนวโน้มที่เพิ่มสูงขึ้น โดยเฉพาะตั้งแต่ในปี 2562 ที่เริ่มมีการรับซื้อพลังงานสะอาดจากผู้ผลิตพลังงาน Solar ซึ่งก่อนหน้านี้มีพลังงานสะอาดจาก Biomass เป็นสำคัญ 

เมื่อพิจารณาที่สัดส่วนปริมาณการรับซื้อพลังงานสะอาด ในปี 2564 เห็นได้ว่า พลังงานสะอาดจาก Biogas Biomass และ Garbage คิดรวมกันเป็นสัดส่วนร้อยละ 43 ของปริมาณการรับซื้อพลังงานสะอาด ซึ่งเป็นสัดส่วนที่สูง ในขณะที่มีจำนวนผู้ผลิตอยู่น้อยราย
...
จากกราฟ Scatter plot ของ ราคาขาย (Price) กับ ปริมาณของการผลิตพลังงาน (Unit) พบว่า แต่ละพลังงานมีความสัมพันธ์เป็นเส้นตรง (Linear) ซึ่งสามารถนำไปขาดการณ์รายได้และกำไรจากการผลิตพลังงานได้ 

ซึ่งเราสามารถจำแนกผู้ผลิตพลังงานรายเล็กและรายใหญ่ ผ่านการดูปริมาณของการผลิตพลังงาน โดยที่ทางด้านซ้ายจะเป็นรายเล็ก เนื่องจากมีปริมาณการผลิตพลังงานน้อยกว่า ขณะที่ทางด้านขวาจะเป็นรายใหญ่ เนื่องจากมีปริมาณผลิตพลังงานที่สูงกว่า 

นอกจากนี้แล้ว การที่พลังงานสะอาดจาก Biogas Biomass และ Garbage แม้จะมีสัดส่วนจำนวนผู้ผลิตที่น้อย แต่สามารถมีกำลังการผลิตที่สูงได้นั้นเป็นเพราะผู้ผลิตพลังงานจาก Biomass และ Garbage เป็นผู้ผลิตพลังงานรายใหญ่มีกำลังการผลิตที่สูง เห็นได้จาก จุด plot ที่เรียงกันอยู่ทางด้านขวา 
...
เพื่อเป็นกรณีศึกษา เราได้นำสถิติการใช้ไฟฟ้าของบ้านพักที่อยู่อาศัยแห่งหนึ่ง มาศึกษาหาความคุ้มค่าด้านการลงทุนติดตั้งใน Solar Rooftop รายบุคคล โดยจากกราฟ อัตราค่าไฟฟ้าต่อหน่วยไฟฟ้ากับอัตราค่า Ft ตั้งแต่ปี 2016 ถึง 2021 ที่ อัตราค่า Ft มีค่าเป็นลบ เห็นได้ว่า เส้นอัตราค่าไฟฟ้าต่อหน่วยไฟฟ้ากับเส้นอัตราค่า Ft เคลื่อนไหวไม่ได้สอดล้องกัน โดยที่อัตราค่า Ft จะมีการปรับทุกๆ 4 เดือน
...
แต่ในช่วงปี 2022 ที่อัตราค่า Ft มีค่าเป็นบวก เห็นได้ว่า เส้นอัตราค่าไฟฟ้าต่อหน่วยไฟฟ้ากับอัตราค่า Ft มีการเคลื่อนไหวในแนวโน้มที่ไปในทิศทางเดียวกัน กล่าวคือ หากอัตรา Ft ปรับค่าเป็นสูงขึ้น ผู้ใช้ไฟฟ้ารายนี้มีแนวโน้มที่จะจ่ายค่าไฟฟ้าสูงขึ้น ฉะนั้นการเข้ามาลงทุนติดตั้ง Solar Rooftop เพื่อลดภาระค่าไฟฟ้า จึงเป็นประเด็นที่จะเข้ามาช่วยผู้ใช้ไฟฟ้ารายนี้ได้
```Python
...
จากตารางข้างต้น เห็นได้ว่าค่า NPV มีค่าเป็นบวก, ค่า IRR มีค่ามากกว่า ต้นทุนของเงินลงทุนในโครงการ (Inflation Rate), ค่า Payback Period ที่มีค่าน้อยกว่า ระยะการลงทุนของโครงการ นั้น แสดงให้เห็นได้ว่า การลงทุนในการติดตั้ง Solar Rooftop ของผู้ใช้ไฟฟ้ารายนี้นั้นมีความคุ้มค่าน่าลงทุน
